  ...
  if (isLoading) {
    return (
      <article className="rounded-xl bg-[#f7f7f7] p-6 text-right" dir="rtl">
        ...
        <p className="mt-2 text-sm font-medium leading-7 text-[#667085]">
      ...
      <article className="rounded-xl bg-[#f7f7f7] p-6 text-right" dir="rtl">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm font-medium leading-7 text-[#344054]">
          ...
          <button
            ...
            className="h-11 rounded-[10px] border border-[#d0d5dd] px-5 text-sm font-semibold text-[#344054] transition-colors hover:border-[#98a2b3] disabled:cursor-not-allowed disabled:opacity-70"
          >
      ...
      >
        <label className="block">
          ...
          <input
            ...
            className="h-11 w-full rounded-[10px] border border-[#d0d5dd] bg-white px-4 text-sm text-[#1c1c1c] outline-none transition-colors placeholder:text-[#98a2b3] focus:border-[#0a66d2]"
            autoComplete="name"
            required
            minLength={2}
            maxLength={80}
        ...
        <button
          type="submit"
          disabled={isSubmitting}
          className="flex h-12.25 w-full items-center justify-center rounded-[10px] bg-[#0a66d2] px-3.5 py-2 text-sm font-extrabold text-white transition-colors hover:bg-[#095ab8] disabled:cursor-not-allowed disabled:bg-[#8eb7e9]"
        >
